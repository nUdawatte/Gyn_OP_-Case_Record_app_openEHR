...
<div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mt-8">
  ...
  {#if openSections.finalDiagnosis}
    <mb-input path="gynaec_case_record_sidharth.v0/final_diagnosis/problem_diagnosis_name" label="Final Diagnosis" />
    <mb-context bind={{value: 'Established', code: 'at0018', terminology: 'local'}} path="gynaec_case_record_sidharth.v0/final_diagnosis/problem_diagnosis_qualifier/diagnostic_status" />
    <mb-context bind={{value: 'Current', code: 'at0062', terminology: 'local'}} path="gynaec_case_record_sidharth.v0/final_diagnosis/problem_diagnosis_qualifier/current_past" />
    <mb-context path="gynaec_case_record_sidharth.v0/final_diagnosis/language" />
    <mb-context path="gynaec_case_record_sidharth.v0/final_diagnosis/encoding" />
    <mb-context path="gynaec_case_record_sidharth.v0/final_diagnosis/subject" />
  {/if}
</div>
  ...
  {#if openSections.medication}
    {#each Array(medicationOrderCount) as _, index}
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4 p-4 bg-gray-50 rounded-lg border">
        <mb-input path={`gynaec_case_record_sidharth.v0/medication_order/order:${index}/medication_item`} label="Medication" />
        <mb-input path={`gynaec_case_record_sidharth.v0/medication_order/order:${index}/overall_directions_description`} label="Directions" />
        <mb-date path={`gynaec_case_record_sidharth.v0/medication_order/order:${index}/order_details/order_start_date_time`} label="Start Date" />
        <mb-date path={`gynaec_case_record_sidharth.v0/medication_order/order:${index}/order_details/order_stop_date_time`} label="End Date" />
        <mb-context path={`gynaec_case_record_sidharth.v0/medication_order/order:${index}/timing`} />
      </div>
    {/each}
    ...
    <mb-context path="gynaec_case_record_sidharth.v0/medication_order/narrative" />
    <mb-context path="gynaec_case_record_sidharth.v0/medication_order/language" />
    <mb-context path="gynaec_case_record_sidharth.v0/medication_order/encoding" />
    <mb-context path="gynaec_case_record_sidharth.v0/medication_order/subject" />
  {/if}
</div>
  ...
  {#if openSections.services}
    {#each Array(serviceRequestCount) as _, index}
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 p-4 bg-gray-50 rounded-lg border">
        <mb-input path={`gynaec_case_record_sidharth.v0/service_request/current_activity:${index}/service_name`} label="Service Name" />
        <mb-input path={`gynaec_case_record_sidharth.v0/service_request/current_activity:${index}/description`} label="Description" />
        <mb-date path={`gynaec_case_record_sidharth.v0/service_request/current_activity:${index}/service_due`} label="Service Due" />
        <mb-context path={`gynaec_case_record_sidharth.v0/service_request/current_activity:${index}/timing`} />
      </div>
    {/each}
    ...
    <mb-context path="gynaec_case_record_sidharth.v0/service_request/narrative" />
    <mb-context path="gynaec_case_record_sidharth.v0/service_request/language" />
    <mb-context path="gynaec_case_record_sidharth.v0/service_request/encoding" />
    <mb-context path="gynaec_case_record_sidharth.v0/service_request/subject" />
  {/if}
</div>
